...
Import DSL file structure from a Git repository. This procedure's main usage is to set up a CI process.
...
|Include objects |New line separated list of paths to the objects that should be synchronized.
...
image:cloudbees-common-sda::cd-plugins/ec-dsldeploy/help/importdslfromgitnew.png[ImportDslFromGitNew parameters,role="screenshot",width=480]
