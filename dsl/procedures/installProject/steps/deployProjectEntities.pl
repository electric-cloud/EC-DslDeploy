...
my @subProjectEntities = ("project", "procedure", "resourceTemplate", "workflowDefinition", "environmentTemplate", "environment", "componentTemplate", "application", "service", "pipeline", "release", "schedule", "catalog", "report", "dashboard");
