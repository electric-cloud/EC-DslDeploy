    ...
    def "incremental import with only delete commands"() {
        ...
        runProcedure(
          ...
          actualParameter: [
            ...
            incrementalImport: "$plugDir/$pName-$pVersion/lib/dslCode/incremental_ChangeLists/change_list_deletes.json",
    ...
    def "incremental import with failing delete commands"() {
        ...
        runProcedure(
          ...
          actualParameter: [
            config: "this value does not matter when skipping Checkout changes, but is required",
            dest: "$plugDir/$pName-$pVersion/lib/dslCode/top_objects",
            incrementalImport: "$plugDir/$pName-$pVersion/lib/dslCode/incremental_ChangeLists/change_list_deletes_failures.json",
            repoUrl: "skip_checkout_changes_step_please",
            rsrcName: "local"
          ]
        )""")
