...
class NMB-27865 extends PluginTestHelper {
  ...
  def "NMB-27865"() {
    ...
    then:
      ...
      assert getProjectProperty("/projects/pName/Changes/C2834144/SM_Change_Approved")
        == 'false'
      assert getProjectProperty("/projects/pName/Changes/C2835095/EJ_ServiceManager_EventinLastSeq")
        == '1'
      assert getProjectProperty("/projects/pName/Framework/C2835095/frmSvcImageTag")
        == '1.0.80'
